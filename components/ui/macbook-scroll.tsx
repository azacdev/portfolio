...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="h-full flex flex-col items-center py-0 md:pt-16 md:pb-80 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100 scale-50"
    >
      <motion.h2
        style={{
      ...
      >
        <span>
          An intricately designed content management dashboard <br />{" "}
          distinguished by its sophisticated interface and enhanced
          functionality
        </span>
      </motion.h2>
      {/* Lid */}
